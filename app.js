...
<section><div class="section-heading"><div><h2>Start with this call order</h2><p>Editorial call order based on task proximity, service-area evidence and direct credential checks.</p></div><a class="text-link" href="#directory">All candidates →</a></div><div class="shortlist">${data.businesses
    .filter((b) => b.priority)
