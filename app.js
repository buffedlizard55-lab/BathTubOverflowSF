...
${(() => {
    ...
    const ladder = [
      ...
      ["Directory / marketing", "Indexed Yelp, Thumbtack, BBB, BuildZoom, Angi and company-site extracts", c.total - read - c.registryOnly, "Names, ratings, badges, service-area statements and short review excerpts. Discovery only — a platform badge is not a license."],
    ];
