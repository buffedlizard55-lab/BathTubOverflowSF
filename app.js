...
${directionCard("w9-ct-plumbing-fire-protection", "REGULATOR-READ 94122", "Active C-36 plus C-16, and the only wave-9 record where CSLB itself — not a directory — places the business inside ZIP 94122, at 1847 48th Ave. The same address and phone are already stored against a different licence number that has never been read on CSLB, so the contracting entity has to be confirmed before anything else.", [325, 316, 306])}
...
${directionCard("w9-kevel-home-performance", "RENTAL-OCCUPIED · TRADE UNVERIFIED", "Registry-only lead: a 94122 firm address with five plumbing and water-heater permit rows, and four attributable reviews including one describing work carried out while tenants were in place. But the Yelp categories are HVAC, energy and insulation rather than plumbing or drywall, no CSLB page was read, and Angi prints that this business does not offer free estimates.", [306, 313, 343, 344])}
</div></section>
